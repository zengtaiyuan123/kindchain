...
export function courierPresentationAtZoom(mode, stage) {
  // v51: each courier keeps its home layers, but earns one more "model"
  // stage — the default Earth view now shows real messengers, not a sky of
  // anonymous traces. Traces remain at each courier's outermost reach so the
  // "approaching its layer" language survives.
  const matrix = {
    hand: { REGION: "model", CITY: "model", DISTRICT: "model", COMMUNITY: "model" },
    pigeon: { ORBIT: "trace", EARTH: "model", CONTINENT: "model", COUNTRY: "model", REGION: "model", CITY: "model", DISTRICT: "model", COMMUNITY: "model" },
    carriage: { CONTINENT: "trace", COUNTRY: "model", REGION: "model", CITY: "model", DISTRICT: "model" },
    rail: { CONTINENT: "model", COUNTRY: "model", REGION: "model", CITY: "model" },
    plane: { ORBIT: "trace", EARTH: "model", CONTINENT: "model", COUNTRY: "model", REGION: "trace", CITY: "trace" },
    rocket: { ORBIT: "model", EARTH: "model", CONTINENT: "model" },
    starship: { ORBIT: "model", EARTH: "model" },
  };
